...
void viterbi_inference (	double *X,double *Q,
				double *beg_seq,double *end_seq,
				int nbclass,int dim,int nbseq,
				double *w,
				double *lab_tok);

void viterbi_inference_sequence (	double *X,double *Q,
					int T,
					int nbclass,int dim,
					double *w,
					double *lab_tok);
...
void viterbi_inference (	double *X,double *Q,
	...
	for(i=0;i<nbseq;i++) {
		...
		viterbi_inference_sequence	(X+T0*dim,Q+T0,
						T,
						nbclass,dim,w,
						lab_tok+T0);
	}
