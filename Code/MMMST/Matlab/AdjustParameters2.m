function result = AdjustParameters2()
    i=1;
    for knn =50
        for sigma = 5:1:5
          for timeslot = 0
            result = [];
        	for nc = 50:450:500
                for lambda =100:100:100
                    for gamm =100:100:100
                        for sparsity = 0.1
                            for timeslotD = 0:23
                        sourceDir = 'D:\Dropbox\Dropbox\Project\MSRA\Result\Features\Beijing\';
                        targetDir = 'D:\Dropbox\Dropbox\Project\MSRA\Result\Features\Shenzhen\';
...
%                         TestClustering(targetDir,dictDirectory,timeslot,sparsity);
                ...
                save(strcat('result/SZ/',num2str(timeslot)),'result');
            end
        end
    end
end