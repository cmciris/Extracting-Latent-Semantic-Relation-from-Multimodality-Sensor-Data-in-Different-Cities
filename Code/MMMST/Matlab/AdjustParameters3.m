function result = AdjustParameters3()
    i=1;
    for knn =50
        for sigma = 5:1:5
          for timeslot = 23
        	...
        	for nc = 50:450:50
                for lambda =500:100:500
                    for gamm =100:100:100
                        ...
                        targetDir = 'D:\Dropbox\Dropbox\Project\MSRA\Result\Features\Tianjin\';
...
%                         dictDirectory = strcat('D:\Result\Temporary\Dict\0.015\010\inter-1\knn_',num2str(knn),'\sigma_',num2str(sigma),'\nc_',num2str(nc),'\lambda_',num2str(lambda),'\gamma_',num2str(gamm),'\');
                        ...
                        N = 100;
% % % %                         
                        [accOur, accB1, accB2, accB3, accB4, accB5] = ExpSCTransfer2(sourceDir, targetDir, dictDirectory, timeslot, timeslotD, ratio, N, rep, sparsity);
...
%                 save(strcat('result/TJ/',num2str(timeslot)),'result');
            end
        end
    end
end